    ...
    (async () => {
        try {
            ...
            await Promise.all([
                ...
                db.query(`ALTER TABLE destinations ALTER COLUMN radius_meter SET DEFAULT 50000`),
                db.query(`UPDATE destinations SET radius_meter = 50000 WHERE radius_meter IS NULL OR radius_meter < 50000`),
