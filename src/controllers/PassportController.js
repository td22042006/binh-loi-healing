    ...
    async index(req, res) {
        try {
            ...
            const missions = [
                ...
                { id: 2, name: 'Sứ giả Làng nghề', desc: 'Tham gia workshop làm nhang', progress: collectedStamps.some(s => s.slug === 'lang-nghe-nhang' && s.is_collected) ? 100 : 0, reward: 'Badge: Skillful' },
